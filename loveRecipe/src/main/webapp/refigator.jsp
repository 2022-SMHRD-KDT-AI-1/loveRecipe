			...
			<div class="gtco-container">
				<div class="row animate-box">
					<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
						...
						<fieldset>
							<form action="#">
								재료 : <input type="text" name="ingre1"><br> 갯수 :<input
									type="number" name="number1"><br> <input
									type="button" value="등록" onClick="low_save();">
							</form>
						</fieldset>
			...
			<div class="gtco-container">
				<div class="row animate-box">
					<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
						...
						<fieldset>
							<form action="#">
								재료 : <input type="text" name="ingre2"><br> 갯수 :<input
									type="number" name="number2"><br> <input
									type="button" value="등록" onClick="mid_save()">
							</form>
						</fieldset>
			...
			<div class="gtco-container">
				<div class="row animate-box">
					<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
						...
						<fieldset>
							<form action="#">
								재료 : <input type="text" name="ingre3"><br> 갯수 :<input
									type="number" name="number3"><br> <input
									type="button" value="등록" onClick="high_save()">
							</form>
						</fieldset>
